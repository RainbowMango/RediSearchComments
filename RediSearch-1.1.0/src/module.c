...
overwritten //Ë÷ÒýÃû×Ö£¬Ã¿¸öË÷ÒýºÃ±ÈÒ»ÕÅ±íµÄÃû×Ö£¬²»¹ý´Ë´¦±í¸ñÎªµ¹ÅÅ±í
...
int CreateIndexCommand(RedisModuleCtx *ctx, RedisModuleString **argv, int argc) {
  ...
  if (argc < 5) {
    return RedisModule_WrongArity(ctx); //¼ì²é²ÎÊý¸öÊý£¬´´½¨Ë÷ÒýÖÁÉÙÐèÒª5¸ö²ÎÊý¡£ "FT.CREATE" "Ë÷ÒýÃû×Ö" "SCHEMA" "TEXT" "ÓòÃû×Ö"
  }
...
int RediSearch_InitModuleInternal(RedisModuleCtx *ctx, RedisModuleString **argv, int argc) {
  ...
  RM_TRY(RedisModule_CreateCommand, ctx, RS_ADD_CMD, AddDocumentCommand, "write deny-oom", 1, 1, 1); //Ìí¼ÓÎÄµµÃüÁî FT.CREATE
